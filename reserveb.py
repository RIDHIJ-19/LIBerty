...
class reserve(Toplevel):
    def __init__(self):
        ...
        # heading,image
        heading = Label(self.topFrame, text=' Reserve', font=' arial 30 bold', fg="#51702c", bg='white')
        ...
        # button
        button = Button(self.bottomFrame, text='Reserve', command=self.delmember, fg='white', bg="#51702c")
