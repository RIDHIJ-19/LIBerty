...
class adminlogin(Toplevel):
    def __init__(self):
        ...
        # heading,image
        heading = Label(self.topFrame, text="Good friends, good books, \n and a sleepy conscience:\n this is the ideal "
                                            "life.",
                        font=' arial 20 bold', fg="#51702c", bg='white')
        ...
        #ID
        self.lbl_name=Label(self.bottomFrame,text='Admin_id:',font='arial 10 bold',bg="#c4b48c",fg="black")
        self.lbl_name.place(x=40,y=40)
        self.ent_name=Entry(self.bottomFrame,width=30,bd=4)
        self.ent_name.insert(0,'PLEASE ENTER ADMIN ID')
